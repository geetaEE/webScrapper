...
public class WSUIControls 
{
	 ...
	 *
	 * @param urlTextField the new url text field
	 */
	 ...
	 *
	 * @param titleTextField the new title text field
	 */
	 ...
	 *
	 * @param exitButton the new exit button
	 */
	 ...
	 *
	 * @param extractDataTypeComboBox the new extract data type combo box
	 */
	 ...
	 *
	 * @param unStructedRadioButton the new un structed radio button
	 */
	 ...
	 *
	 * @param structedRadioButton the new structed radio button
	 */
	 ...
	 *
	 * @param dataTypeRadioButtonGroup the new data type radio button group
	 */
	 ...
	 *
	 * @param extractDataTypeSelectionpanel the new extract data type selectionpanel
	 */
	public void setExtractDataTypeSelectionpanel(
			JPanel extractDataTypeSelectionpanel) {
	 ...
	 *
	 * @param btnPreview the new btn preview
	 */
	 ...
	 *
	 * @param previewRunQueryPanel the new preview run query panel
	 */
	 ...
	 *
	 * @param extractTocomboBox the new extract tocombo box
	 */
	 ...
	 *
	 * @param lblExtractTo the new lbl extract to
	 */
	 ...
	 * Sets the btn reset.
	 *
	 * @param btnReset the new btn reset
	 */
	 ...
	 *
	 * @param mntmExtractProcess the new mntm extract process
	 */
	 ...
	 *
	 * @param mntmBatchProcess the new mntm batch process
	 */
	 ...
	 *
	 * @param batchProcessPanel the new batch process panel
	 */
	 ...
	 *
	 * @param buttonExit the new button exit
	 */
	 ...
	 *
	 * @param pathtextField the new pathtext field
	 */
	 ...
	 *
	 * @param batchProcessBrowsePanel the new batch process browse panel
	 */
	 ...
	 *
	 * @param extractProcessPanel the new extract process panel
	 */
	 ...
	 *
	 * @param btnProcess the new btn process
	 */
	 ...
	 *
	 * @param lblExtractProcess the new lbl extract process
	 */
	 ...
	 *
	 * @param queryRunnerControlBoxPanel the new query runner control box panel
	 */
	 ...
	 *
	 * @param btnRunQuery the new btn run query
	 */
	 ...
	 *
	 * @param htmlControlScrollPanel the new html control scroll panel
	 */
	 ...
	 *
	 * @param htmlControlList the new html control list
	 */
	 ...
	 *
	 * @param extractButton the new extract button
	 */
