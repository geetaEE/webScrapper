...
public class WSUIControlsManager {
    ...
    public void createBatchProcessPanel() {
        ...
        btnProcess.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (f.exists()) {
                    JOptionPane.showMessageDialog(frame, "Batch Process exported data successfully.", UIConstants.WEB_SCRAPPER,
    ...
    public void resetBatchProcessPanel() {
        ...
        wsUIControls.getBatchProcessPanel().setBounds(UIConstants.WSUM_X_35, UIConstants.WSUM_Y_35, UIConstants.WSUM_WIDTH_35,
                UIConstants.WSUM_HEIGHT_35);
    ...
    public void resetAllExtractProcessPanel() {
        ...
        wsUIControls.getPreviewRunQueryPanel().setBounds(UIConstants.WSUM_X_37, UIConstants.WSUM_Y_37, UIConstants.WSUM_WIDTH_37,
                UIConstants.WSUM_HEIGHT_37);
        wsUIControls.getExtractProcessPanel().setBounds(UIConstants.WSUM_X_38, UIConstants.WSUM_Y_38, UIConstants.WSUM_WIDTH_38,
                UIConstants.WSUM_HEIGHT_38);
    ...
    public void resetExtractProcessPanel() {
        ...
        wsUIControls.getQueryRunnerControlBoxPanel().setVisible(false);
        wsUIControls.getPreviewRunQueryPanel().setBounds(UIConstants.WSUM_X_40, UIConstants.WSUM_Y_40, UIConstants.WSUM_WIDTH_40,
                UIConstants.WSUM_HEIGHT_40);
        wsUIControls.getExtractProcessPanel().setBounds(UIConstants.WSUM_X_41, UIConstants.WSUM_Y_41, UIConstants.WSUM_WIDTH_41,
                UIConstants.WSUM_HEIGHT_41);
    ...
    public void expandExtractProcessPanel() {
        ...
        wsUIControls.getPreviewRunQueryPanel().setBounds(UIConstants.WSUM_X_44, UIConstants.WSUM_Y_44, UIConstants.WSUM_WIDTH_44,
                UIConstants.WSUM_HEIGHT_44);
        wsUIControls.getExtractProcessPanel().setBounds(UIConstants.WSUM_X_45, UIConstants.WSUM_Y_45, UIConstants.WSUM_WIDTH_45,
                UIConstants.WSUM_HEIGHT_45);
        frame.setLocationRelativeTo(null);
